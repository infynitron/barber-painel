...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "text-foreground h-10 text-left align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0 *:[[role=checkbox]]:translate-y-0.5",
...
function TableCaption({
  ...
  return (
    <caption
      ...
      className={cn("text-muted-foreground mt-4 text-sm text-left", className)}
      {...props}
    />
  );
}
