...
const CTASection = () => {
  return (
    <section className="py-32 relative overflow-hidden bg-primary">
      ...
      <div className="absolute bottom-20 right-20 w-64 h-64 bg-primary-foreground/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-primary-foreground/20 backdrop-blur-xl border border-primary-foreground/30 rounded-full mb-8 shadow-2xl">
            ...
            <span className="text-primary-foreground font-bold">14 DIAS GRÁTIS - SEM CARTÃO</span>
          </div>
